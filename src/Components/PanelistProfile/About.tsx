...
class About extends React.Component<any, any> {
    ...
    fetchDetails() {
        Promise.resolve()
            ...
            .then(() => ProfileManagementAPI.getOneDetails(ProfilesIds.About, this.props.userId))
            .then((data) => {
                    ...
                    <Card>
                        <CardHeader color="primary">
                            <div className="d-flex align-items-center justify-content-between">
                                <h4>{this.props.language === 'hi' ? 'आपके बारे में' : 'About'}</h4>
                                <div>
                                    <Button
                                        onClick={() => this.create()}
                                        variant="primary"
...
const AboutRedux = reduxForm<FormValue, any>({
    form: 'about',
})(About);
...
const AboutWithRouter = withRouter(connect(mapStateToProps)(AboutRedux));

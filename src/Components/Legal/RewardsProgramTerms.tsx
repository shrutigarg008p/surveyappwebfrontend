                ...
                <Paper className={classes.paper}>
                    ...
                    <div>
                        ...
                        <p style={{ fontSize: '11.5pt' }}>
                            <span style={{ fontFamily: '', color: '#001627', backgroundColor: '#ffffff' }}>&nbsp;</span>
                        </p>
                        
                        <ol style={{ margin: '0pt', paddingLeft: '0pt' }}>
                            <li style={{ marginLeft: '35.65pt', paddingLeft: '0.35pt', fontFamily: '', fontSize: '11.5pt', color: '#001627', backgroundColor: '#ffffff' }}>
                        ...
                        <p style={{ marginTop: '7.5pt', marginBottom: '7.5pt', fontSize: '15pt', backgroundColor: '#ffffff' }}>
                            <strong><span style={{ fontFamily: '' }}>Accumulation Of IndiaPolls Points</span></strong>
                        </p>
                        <ol style={{ margin: '0pt', paddingLeft: '0pt' }}>
                            <li style={{ marginTop: '14pt', marginLeft: '35.65pt', paddingLeft: '0.35pt', fontFamily: '', fontSize: '11.5pt', color: '#001627', backgroundColor: '#ffffff' }}>
                            ...
                            <li style={{ marginLeft: '35.65pt', marginBottom: '14pt', paddingLeft: '0.35pt', fontFamily: '', fontSize: '11.5pt', color: '#001627', backgroundColor: '#ffffff' }}>
                        ...
                        <p style={{ marginTop: '7.5pt', marginBottom: '7.5pt', fontSize: '15pt', backgroundColor: '#ffffff' }}>
                            <strong><span style={{ fontFamily: '' }}>IndiaPolls Points Values</span></strong>
                        </p>
                        <ol style={{ margin: '0pt', paddingLeft: '0pt' }}>
                            <li style={{ marginTop: '14pt', marginLeft: '35.65pt', paddingLeft: '0.35pt', fontFamily: '', fontSize: '11.5pt', color: '#001627', backgroundColor: '#ffffff' }}>
                        ...
                        <p style={{ marginTop: '7.5pt', marginBottom: '7.5pt', fontSize: '15pt', backgroundColor: '#ffffff' }}>
                            <strong><span style={{ fontFamily: '' }}>Redemption Of IndiaPolls Points</span></strong>
                        </p>
                        <ol style={{ margin: '0pt', paddingLeft: '0pt' }}>
                            <li style={{ marginTop: '14pt', marginLeft: '35.65pt', paddingLeft: '0.35pt', fontFamily: '', fontSize: '11.5pt', color: '#001627', backgroundColor: '#ffffff' }}>
                            ...
                            <li style={{ marginLeft: '36pt', marginBottom: '14pt', textIndent: '-18pt', fontFamily: '', fontSize: '11.5pt', color: '#001627', backgroundColor: '#ffffff', listStylePosition: 'inside' }}>
                        ...
                        <p style={{ marginTop: '7.5pt', marginBottom: '7.5pt', fontSize: '15pt', backgroundColor: '#ffffff' }}>
                            <strong><span style={{ fontFamily: '' }}>Administration Of Rewards</span></strong>
                        </p>
                        <ol style={{ margin: '0pt', paddingLeft: '0pt' }}>
                            <li style={{ marginTop: '14pt', marginLeft: '35.65pt', paddingLeft: '0.35pt', fontFamily: '', fontSize: '11.5pt', color: '#001627', backgroundColor: '#ffffff' }}>
                                DataXing reserves the right to appoint a third party to administer its Points Program and rewards. You should read the&nbsp;<a id="_cmntref1"><strong><span style={{ color: '#3f51b5' }}><a href="/#/privacy-policy">Privacy Policy</a></span></strong>&nbsp;</a><a href="#_cmnt1" style={{ textDecoration: 'none' }}><span className="CommentReference" style={{ fontFamily: 'Calibri' }}></span></a>regarding information that will be passed to third parties in order to administer the Points Program and rewards.
                            </li>
                            <li style={{ marginLeft: '35.65pt', marginBottom: '14pt', paddingLeft: '0.35pt', fontFamily: '', fontSize: '11.5pt', color: '#001627', backgroundColor: '#ffffff' }}>

            ...
            <Container maxWidth="lg" className={classes.content}>
                <Paper className={classes.paper}>
                    ...
                    <div>
                        ...
                        <p><span style={{ color: '#000000' }}><span style={{ fontFamily: 'Times New Roman,serif' }}><span style={{ fontSize: 'large' }}>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in IndiaPolls. This policy is not applicable to any information collected offline or via channels other than this website.</span></span></span></p>
                        <p><span style={{ color: '#000000' }}><span style={{ fontFamily: 'Times New Roman,serif' }}><span style={{ fontSize: 'xx-large' }}><u><strong>Your Commitments and Association with IndiaPolls.</strong></u></span></span></span></p>
                        <p><span style={{ color: '#000000' }}><span style={{ fontFamily: 'Times New Roman,serif' }}><span style={{ fontSize: 'large' }}>IndiaPolls techniques your information and, the place applicable, on the basis of your voluntary participation in this market research study. The categorical purpose of our agreement with you is to gain information from and about you and, the place applicable, other contributors of your household, to be used for the functions described in this Notice. When you register for an Account, we can also ask for your contact information, such as objects such as name, enterprise name, address, electronic mail address, and smartphone number.</span></span></span></p>
                        ...
                        <ol>
                            ...
                            <li>
                                <p><span style={{ color: '#000000' }}><span style={{ fontFamily: 'Times New Roman,serif' }}><span style={{ fontSize: 'large' }}>All the data you provide to IndiaPolls is Accurate and true.</span></span></span></p>
                            </li>
                            <li>
                                <p><span style={{ color: '#000000' }}><span style={{ fontFamily: 'Times New Roman,serif' }}><span style={{ fontSize: 'large' }}>Neither you nor any of your family members is an employee of IndiaPolls.</span></span></span></p>
                            </li>
                            <li>

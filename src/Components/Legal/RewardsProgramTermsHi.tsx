    ...
    return (
        <div className={classes.root}>
            <AppBar position="static" className={classes.appBar}>
                <Toolbar>
                    <Typography variant="h6"> रिवार्ड्स कार्यक्रम की शर्तें</Typography>
                </Toolbar>
            </AppBar>
            <Container maxWidth="lg" className={classes.content}>
                <Paper className={classes.paper}>
                    ...
                    रिवार्ड्स कार्यक्रम की शर्तें
                    </Typography>
                    <ResponsiveIframe url="https://onedrive.live.com/embed?resid=CAE33E44DD3C57EE%2154086&authkey=!AF3BE5zPh9lRbrY&em=2" />

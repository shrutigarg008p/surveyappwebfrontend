...
class Shopping extends React.Component<any, any> {
    ...
    fetchDetails() {
        Promise.resolve()
            ...
            .then(() => ProfileManagementAPI.getOneDetails(ProfilesIds.Shopping, this.props.userId))
            .then((data) => {
    ...
    formValues() {
        return {
            ...
            profileId: ProfilesIds.Shopping,
                    ...
                    <Card>
                        <CardHeader color="primary">
                            <div className="d-flex align-items-center justify-content-between">
                                <h4>{this.props.language === 'hi' ? 'खरीदारी' : 'Shopping'}</h4>
                                <div>
                                    <Button
                                        onClick={() => this.create()}
                                        variant="primary"
...
const ShoppingRedux = reduxForm<FormValue, any>({
    form: 'Professional',
})(Shopping);
...
const ShoppingWithRouter = withRouter(connect(mapStateToProps)(ShoppingRedux));

export { ShoppingWithRouter as Shopping };

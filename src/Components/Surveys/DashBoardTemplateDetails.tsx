...
import {NewsLetterAPI, SurveysAPI} from "../../API";
import {Confirmation} from "../../Shared/Confirmation";


class DashboardTemplateDetails extends React.Component<any, any> {
    static defaultProps = {
        languageId: null,
        hideMenu: false,
        onUpdate: () => null,
    ...
    onDelete() {
        Promise.resolve()
            ...
            .then(() => {
                ...
                return SurveysAPI.deleteOneTemplate(this.props.id);
            })
            .then((country) => {
...
const DashboardTemplateDetailsWithRouter = withRouter(DashboardTemplateDetails);

export { DashboardTemplateDetailsWithRouter as DashboardTemplateDetails };

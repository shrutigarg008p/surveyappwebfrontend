...
class SampleQuestionsDetails extends React.Component<any, State> {
    static defaultProps = {
        languageId: null,
        hideMenu: false,
        onUpdate: () => null,
...
const SampleQuestionsDetailsWithRouter = withRouter(SampleQuestionsDetails);

export { SampleQuestionsDetailsWithRouter as SampleQuestionsDetails };

...
function CookiePolicyHi() {
    ...
    return (
        ...
        <AppBar position="static" className={classes.appBar}>
            <Toolbar>
                <Typography variant="h6">कुकी नोटिस</Typography>
            </Toolbar>
        </AppBar>
        <Container maxWidth="lg" className={classes.content}>
            <Paper className={classes.paper}>
                ...
                <ResponsiveIframe url="https://onedrive.live.com/embed?resid=CAE33E44DD3C57EE%2154085&authkey=!AF3BE5zPh9lRbrY&em=2"/>
            </Paper>

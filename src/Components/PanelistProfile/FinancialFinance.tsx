...
class PersonalFinance extends React.Component<any, any> {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchDetails() {
        Promise.resolve()
            ...
            .then(() => ProfileManagementAPI.getOneDetails(ProfilesIds.PersonalFinance, this.props.userId))
            .then((data) => {
...
const PersonalFinanceRedux = reduxForm<FormValue, any>({
...
const PersonalFinanceWithRouter = withRouter(connect(mapStateToProps)(PersonalFinanceRedux));

export { PersonalFinanceWithRouter as PersonalFinance };

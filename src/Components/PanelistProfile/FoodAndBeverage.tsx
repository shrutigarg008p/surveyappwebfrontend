...
class FoodAndBeverage extends React.Component<any, any> {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchDetails() {
        Promise.resolve()
            ...
            .then(() => ProfileManagementAPI.getOneDetails(ProfilesIds.FoodAndBeverage, this.props.userId))
            .then((data) => {
    ...
    formValues() {
        return {
            ...
            profileId: ProfilesIds.FoodAndBeverage,
                    ...
                    <Card>
                        <CardHeader color="primary">
                            <div className="d-flex align-items-center justify-content-between">
                                <h4>{this.props.language === 'hi' ? 'खाद्य और पेय पदार्थ' : 'Food And Beverage'}</h4>
                                <div>
                                    <Button
                                        onClick={() => this.create()}
                                        variant="primary"
...
const FoodAndBeverageRedux = reduxForm<FormValue, any>({
...
const FoodAndBeverageWithRouter = withRouter(connect(mapStateToProps)(FoodAndBeverageRedux));

export { FoodAndBeverageWithRouter as FoodAndBeverage };

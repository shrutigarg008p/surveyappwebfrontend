...
class Auto extends React.Component<any, any> {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchDetails() {
        Promise.resolve()
            ...
            .then(() => ProfileManagementAPI.getOneDetails(ProfilesIds.Auto, this.props.userId))
            .then((data) => {
                    ...
                    <Card>
                        <CardHeader color="primary">
                            <div className="d-flex align-items-center justify-content-between">
                                <h4>{this.props.language === 'hi' ? 'ऑटो' : 'Auto'}</h4>
                                <div>
                                    <Button
                                        onClick={() => this.create()}
                                        variant="primary"
...
const AutoRedux = reduxForm<FormValue, any>({
    form: 'Auto',
})(Auto);
...
const AutoWithRouter = withRouter(connect(mapStateToProps)(AutoRedux));

export { AutoWithRouter as Auto };

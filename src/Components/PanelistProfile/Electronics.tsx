...
class Electronics extends React.Component<any, any> {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchDetails() {
        Promise.resolve()
            ...
            .then(() => ProfileManagementAPI.getOneDetails(ProfilesIds.Electronics, this.props.userId))
            .then((data) => {
    ...
    formValues() {
        return {
            ...
            profileId: ProfilesIds.Electronics,
                    ...
                    <Card>
                        <CardHeader color="primary">
                            <div className="d-flex align-items-center justify-content-between">
                                <h4>{this.props.language === 'hi' ? 'इलेक्ट्रोनिक' : 'Electronic'}</h4>
                                <div>
                                    <Button
                                        onClick={() => this.create()}
                                        variant="primary"
...
const ElectronicsRedux = reduxForm<FormValue, any>({
    form: 'Electronics',
})(Electronics);
...
const ElectronicsWithRouter = withRouter(connect(mapStateToProps)(ElectronicsRedux));

export { ElectronicsWithRouter as Electronics };

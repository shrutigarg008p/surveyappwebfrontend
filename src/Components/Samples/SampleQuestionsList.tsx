...
import {SampleQuestionsForm} from "./SampleQuestionForm";
import {SampleQuestionsDetails } from "./SampleQuestionsDetails";
...
export class SampleQuestionsList extends Component<any, State> {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchList(): Promise<void> {
        return Promise.resolve()
            ...
            .then(() => SamplesAPI.getQuestions( this.props.id))
            .then((countries) => {
    ...
    onDelete(id) {
        Promise.resolve()
            ...
            .then(() => {
                ...
                return SamplesAPI.removeQuestion(id);
            })
            .then((country) => {
            ...
            <>
                ...
                >
                    <Modal.Header closeButton>
                        <h5 className="mb-0 mt-1">Sample Questions</h5>
                        <div

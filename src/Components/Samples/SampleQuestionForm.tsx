...
class SampleQuestionsForm extends React.Component<any, any> {
    constructor(props) {
        super(props);
        this.state = {
    ...
    fetchDetails() {
        Promise.resolve()
            ...
            .then(() => {
                ...
                return SamplesAPI.getOneQuestion(this.props.id);
            })
            .then((data) => {
    ...
    createSecQuestion() {
        ...
        return Promise.resolve()
            ...
            .then(() => SamplesAPI.createQuestion(valuesIn))
            .then((country) => {
...
const SampleQuestionsFormRedux = reduxForm<FormValue, any>({
    form: 'SampleQuestionsForm',
})(SampleQuestionsForm);


const SampleQuestionsFormWithRouter = withRouter(SampleQuestionsFormRedux);

export { SampleQuestionsFormWithRouter as SampleQuestionsForm };
